...
class DatabaseHelper
{
    ...
    public function updateDatabase(): void
    {
        ...
        // GeoIP routing schema — creates the geo_continents/countries/regions
        // /cities reference tables and the geo_routing_rules table edited via
        // the GeoIP Zone page. Tables are empty unless the operator imports
        // sql/poweradmin-mysql-geoip-data.sql afterwards.
        if ($dbType === 'mysql') {
            $this->installGeoipRoutingSchema();
        }
    }

    private function installGeoipRoutingSchema(): void
    {
